...
I absolutely **LOVE** <span style="color: blue">#rstats</span> but Python was my first programming language. Sometimes I need to fall back on that because I know how to work with certain data structures outside of data frames better. 
