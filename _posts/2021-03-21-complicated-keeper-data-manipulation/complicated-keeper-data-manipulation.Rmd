...
As you can imagine, this is a nightmare to track in a spreadsheet as commissioner. 
...
Now we have a basic draft board. My team was the 9th slot. I traded away Julio Jones and cut Odell Beckham Jr. after he went to Injured Reserve. We need to build a logic to represent these moves, since they are no longer eligible for me to keep.
...
The NFL and fantasy football is a game of states by week. Using the **{lubridate}**, create week 1 of the NFL season from the *timestamp* field in the transactions data frame. 
...
Thanks for following along, and again shoutout to [Tan](https://twitter.com/_TanHo) for the awesome package!
